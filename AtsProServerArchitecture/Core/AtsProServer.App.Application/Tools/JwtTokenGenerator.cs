...
namespace AtsProServer.App.Application.Tools
{
    public class JwtTokenGenerator
    {
        public static TokenResponseDto GenerateToken(CheckUserResponseDto dto)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(JwtTokenDefaults
                .Key));
            ...
            JwtSecurityToken token = new JwtSecurityToken(issuer: JwtTokenDefaults
                .ValidIssuer, audience: JwtTokenDefaults.ValidAudience,
